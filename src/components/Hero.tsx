      ...
      <div className="container mx-auto px-6 text-center relative z-10">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="animate-fade-in-up opacity-0" style={{ animationDelay: '0.4s' }}>
            <h1 className="text-5xl md:text-7xl lg:text-8xl font-bold mb-6 gradient-text overflow-visible whitespace-nowrap leading-tight drop-shadow-[0_2px_8px_rgba(0,0,0,0.7)] px-2 pt-2.5 ">
              SOTA NIGEL
            </h1>
          </div>
